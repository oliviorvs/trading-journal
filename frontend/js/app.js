...
Object.assign(window, {
  ...
  switchAnalyzerSummaryMode: lazy('./analyzer.js', 'switchAnalyzerSummaryMode'),
  copyAnalyzerSummary: lazy('./analyzer.js', 'copyAnalyzerSummary'),
  downloadAnalyzerSummary: lazy('./analyzer.js', 'downloadAnalyzerSummary'),
